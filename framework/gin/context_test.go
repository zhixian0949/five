...
import (
	...
	testdata "github.com/zhixian0949/five/framework/gin/testdata/protoexample"
)
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/zhixian0949/five/framework/gin.handlerNameTest$", c.HandlerName())
}
